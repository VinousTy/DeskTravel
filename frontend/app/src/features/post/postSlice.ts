...
const apiUrlPost: string = String(process.env.REACT_APP_DEV_API_URL_POST);
const apiUrlMyPost: string = String(process.env.REACT_APP_DEV_API_URL_MY_POST);
const apiUrlPostImage: string = String(
  process.env.REACT_APP_DEV_API_URL_POST_IMAGE
);
const apiUrlComment: string = String(process.env.REACT_APP_DEV_API_URL_COMMENT);
